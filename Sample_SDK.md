...
- `MoveLineral` осуществляет линейное движение (линейное движение) робота по декартовым координатам.
- `MoveCartesian` осуществляет осевое движение (осевое движение) робота по декартовым координатам.
- `MoveJoint` осуществляет движение (осевое движение) осей робота до заданного значения углов поворота осей.
- `MoveArc` осуществляет движение по дуге (движение по дуге).  
...
- Для построения дуги необходимо указать дополнительную (промежуточную) точку, которая .
