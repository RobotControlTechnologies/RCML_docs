...
- `MoveLineral` осуществляет линейное движение (LINEAR Interpolated Motion) робота по декартовым координатам.
- `MoveCartesian` осуществляет осевое движение (JOINT Interpolated motion) робота по декартовым координатам.
- `MoveJoint` осуществляет движение (JOINT Interpolated motion) осей робота до заданного значения углов поворота осей.
- `MoveArc` осуществляет движение по дуге (CIRCULAR Interpolated Motion).  
