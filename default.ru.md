...
- *[Repository/Deployer]* - содержит данные для идентификации в Репозитории, заполнение этой секции необходимо только если вы пользуетесь промышленной версией RCML или являетесь разработчиком RCML модулей, подробнее в разделе ["Получение лицензии RCML"](#16rcml). Содержит следующие свойства:
...
- *--hardware-info* - сбор информации об аппаратной конфигурации, необходимо для получения лицензии, подробнее в разделе ["Сбор аппаратной информации"](#163).
...
6. Зарезервированные слова, перечисленные в разделе ["Перечень зарезервированных ключевых слов"](#11-1).
...
По аналогии с языками программирования C и C++, выполнение начинается с функции с именем *main*, которая обязательно должна присутствовать. Данное утверждение относится к исполняемым программам на *RCML*, не являющимся библиотеками. Подробнее об библиотеках в разделе ["Создание файла библиотеки RCML"](#10rcml).
...
```
Процесс создания библиотеки описан в разделе ["Создание файла библиотеки RCML"](#10rcml).
...
# 13 Подробнее об интерфейсных идентификаторах применительно к библиотекам
...
# 15 Допонительные разделы документации
### 15.1 Документация для разработчиков
...
### 15.2 Доступные модули и их API
...
# 16 Получение лицензии RCML
### 16.1 Регистрация пользователя в Репозитории
...
### 16.3 Сбор аппаратной информации
...
### 16.4 Отправка аппаратной конфигурации
